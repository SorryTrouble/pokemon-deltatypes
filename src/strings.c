...
const u8 gText_ConfirmStarterChoiceGrass[] = _("Do you choose the Grass/Music\nPOKéMON?");
const u8 gText_ConfirmStarterChoiceFire[] = _("Do you choose the Fire/Mouse\nPOKéMON?");
const u8 gText_ConfirmStarterChoiceWater[] = _("Do you choose the Water/Blade\nPOKéMON?");
