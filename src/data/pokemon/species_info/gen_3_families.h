...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_DARK, TYPE_RUDE),
        .catchRate = 255,
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 41,
        .types = MON_TYPES(TYPE_RUDE, TYPE_MUSIC),
        .catchRate = 255,
        .expYield = 56,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_FROG, TYPE_WATER),
        .catchRate = 255,
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FROG, TYPE_MUSIC),
        .catchRate = 120,
    ...
    [SPECIES_RALTS] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_MAGIC, TYPE_COPY),
        .catchRate = 235,
    ...
    [SPECIES_GARDEVOIR_MEGA] =
    {
        ...
        .baseSpAttack  = 165,
        .baseSpDefense = 135,
        .types = MON_TYPES(TYPE_HEART, TYPE_COPY),
        .catchRate = 45,
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_MAGIC, TYPE_BLADE),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 259,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_GALLADE_MEGA] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_FIGHT, TYPE_BLADE),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 309 : 278,
        .evYield_Attack = 3,
        .genderRatio = MON_MALE,
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_DEATH, TYPE_PUPPET),
        .catchRate = 45,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_RED, TYPE_STEEL),
        .catchRate = 60,
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_DEFAULT, TYPE_CAT),
        .catchRate = 255,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_JEWEL, TYPE_RUDE),
        .catchRate = 45,
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_RED, TYPE_CHAOS),
        .catchRate = 255,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_DARK, TYPE_STAR),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_HOLY, TYPE_STAR),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_WATER, TYPE_RED),
        .catchRate = 205,
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WIND, TYPE_COPY),
        .catchRate = 45,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_COPY, TYPE_COLOR),
        .catchRate = 200,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_HOLY, TYPE_MUSIC),
        .catchRate = 120,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_SCYTHE, TYPE_LUCK),
        .catchRate = 30,
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ICE, TYPE_CHAOS),
        .catchRate = 75,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_ICE, TYPE_SPIRIT),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 187,
        .evYield_Speed = 2,
        .genderRatio = MON_FEMALE,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_STAR, TYPE_PUZZ),
        .catchRate = 3,
