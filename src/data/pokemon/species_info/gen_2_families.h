...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_WIND, TYPE_STAR),
        .catchRate = 255,
...
#if P_FAMILY_TOGEPI
#define TOGEPI_FAMILY_TYPE1 TYPE_HEART
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_ELEC, TYPE_HOLY),
        .catchRate = 235,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_DUST, TYPE_WIND),
        .catchRate = 255,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .types = MON_TYPES(TYPE_WIND, TYPE_DUST),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 230,
    #elif P_UPDATED_EXP_YIELDS >= GEN_6
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 42,
        .types = MON_TYPES(TYPE_RUDE, TYPE_LUCK),
        .catchRate = 30,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_DEFAULT, TYPE_LUCK),
        .catchRate = 190,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_BLADE, TYPE_SMELL),
        .catchRate = 45,
        .expYield = 88,
        .evYield_Attack = 1,
        .itemRare = ITEM_POISON_BARB,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_DARK, TYPE_JEWEL),
        .catchRate = 60,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_DEFAULT, TYPE_STAR),
        .catchRate = 120,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_ICE, TYPE_RED),
        .catchRate = 45,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_BLADE, TYPE_WIND),
        .catchRate = 25,
        .expYield = 163,
        .evYield_Defense = 2,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .baseSpAttack  = 20,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_COLOR, TYPE_CHAOS),
        .catchRate = 45,
