...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARLY] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_SCYTHE, TYPE_WIND),
        .catchRate = 255,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 34,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_CAT),
        .catchRate = 235,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 42,
        .types = MON_TYPES(TYPE_WIND, TYPE_ORDER),
        .catchRate = 120,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 44,
        .types = MON_TYPES(TYPE_SPIRIT, TYPE_WIND),
        .catchRate = 125,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .baseSpAttack  = 44,
        .baseSpDefense = 56,
        .types = MON_TYPES(TYPE_RABBIT, TYPE_HEART),
        .catchRate = 190,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .baseSpAttack  = 41,
        .baseSpDefense = 41,
        .types = MON_TYPES(TYPE_RUDE, TYPE_SMELL),
        .catchRate = 225,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .baseSpAttack  = 24,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_STEEL, TYPE_MUSIC),
        .catchRate = 255,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .baseSpAttack  = 92,
        .baseSpDefense = 108,
        .types = MON_TYPES(TYPE_DEATH, TYPE_PUZZ),
        .catchRate = 100,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_FROG, TYPE_SMELL),
        .catchRate = 140,
...
#if P_FAMILY_ROTOM
#define ROTOM_FAMILY_TYPES { TYPE_VIRUS, TYPE_PUPPET }
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_VIRUS, TYPE_FIRE),
    #else
        .types = ROTOM_FAMILY_TYPES,
    #endif
        .catchRate = 45,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .baseSpDefense = 107,
    #if P_UPDATED_TYPES >= GEN_5
        .types = MON_TYPES(TYPE_VIRUS, TYPE_GRASS),
    #else
        .types = ROTOM_FAMILY_TYPES,
    #endif
        .catchRate = 45,
