...
#define SCATTERBUG_SPECIES_INFO(evolution)                                                  \
    {                                                                                       \
        ...
        .baseSpAttack  = 27,                                                                \
        .baseSpDefense = 25,                                                                \
        .types = MON_TYPES(TYPE_COLOR, TYPE_DUST),                                          \
        .catchRate = 255,                                                                   \
        .expYield = 40,                                                                     \
        .evYield_Defense = 1,                                                               \
        .genderRatio = PERCENT_FEMALE(50),                                                  \
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .baseSpAttack  = 65,                                                                            \
        .baseSpDefense = 90,                                                                            \
        .types = MON_TYPES(TYPE_DEFAULT, TYPE_COLOR),                                                   \
        .catchRate = 160,                                                                               \
        .expYield = 165,                                                                                \
        .evYield_Speed = 1,                                                                             \
        .genderRatio = PERCENT_FEMALE(50),                                                              \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 37,
        .types = MON_TYPES(TYPE_BLADE, TYPE_SPIRIT),
        .catchRate = 180,
        .expYield = 65,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .baseSpAttack  = 59,
        .baseSpDefense = 57,
        .types = MON_TYPES(TYPE_HEART, TYPE_SMELL),
        .catchRate = 200,
        .expYield = 68,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_INKAY] =
    {
        ...
        .baseSpAttack  = 37,
        .baseSpDefense = 46,
        .types = MON_TYPES(TYPE_RUDE, TYPE_CHAOS),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .baseSpAttack  = 67,
        .baseSpDefense = 63,
        .types = MON_TYPES(TYPE_JEWEL, TYPE_ICE),
        .catchRate = 45,
        .expYield = 72,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .baseSpAttack  = 74,
        .baseSpDefense = 63,
        .types = MON_TYPES(TYPE_COLOR, TYPE_FIGHT),
        .catchRate = 100,
        .expYield = 175,
        .evYield_Attack = 2,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .baseSpAttack  = 81,
        .baseSpDefense = 67,
        .types = MON_TYPES(TYPE_HOLY, TYPE_MOUSE),
        .catchRate = 180,
        .expYield = 151,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
