...
static const struct SearchOptionText sDexSearchTypeOptions[] =
{
    ...
    {gText_DexEmptyString, gTypesInfo[TYPE_DEFAULT].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_DARK].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_STAR].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_PUPPET].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_CAT].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ELEC].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_HOLY].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_DEATH].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_SCYTHE].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_RUDE].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_RED].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_JEWEL].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_HEART].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ORDER].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_RABBIT].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_DUST].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FIGHT].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_MOUSE].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_PUZZ].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_BLADE].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ICE].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_CHAOS].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_VIRUS].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_COLOR].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_MUSIC].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_COPY].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FROG].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_LUCK].name},
    ...
    {gText_DexEmptyString, gTypesInfo[TYPE_SMELL].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_MAGIC].name},
    {},
};
